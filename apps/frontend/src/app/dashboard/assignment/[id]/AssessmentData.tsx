          ...
          <>
               <div className=" px-4 pt-4 ">
                    <div className="rounded-[28px] px-8 py-6   bg-[#181818CC]">
                         <p className="   mb-4 font-semibold text-[20px] font-bricolage text-white leading-[140%] ">Certainly, Lakshya! Here are customized Question Paper for your CBSE Grade 8 Science classes on the NCERT chapters:</p>
                         ...
                         >
                              {({
                                   ...
                                   loading
                                        ?
                                        <div className=" px-5 py-2 rounded-3xl flex items-center gap-2 bg-white w-fit" >s
                                             <Image src="/assets/Frame.svg" alt="pdf" width={24} height={24} />
                                             <span className=" font-bricolage font-medium text-[16px] text-TWO">Preparing PDF...</span>
                                        </div>

                                        :
                                        <div className=" px-5 py-2 rounded-3xl flex items-center gap-2 bg-white w-fit" >
                                             <Image src="/assets/Frame.svg" alt="pdf" width={24} height={24} />
                                             <span className=" font-bricolage font-medium text-[16px] text-TWO">Download as PDF</span>
                                        </div>
                              }
                         </PDFDownloadLink>
                         ...
                         {data.sections.map(
                              (section, sectionIndex) => (
                                   ...
                                   >
                                        ...
                                        <p className="  italic text-[16px] mb-4">
                                             {section.instruction}
                                        </p>
                                        ...
                                        {section.questions.map(
                                             (question, index) => (
                                                  <div
                                                       key={index}
                                                       className="mb-3 text-[16px] font-inter"
                                                  >
                                                       <p>
                                                            {index + 1}. [
                                                            {question.difficulty}
